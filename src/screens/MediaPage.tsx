...
const requestSavePermission = async (): Promise<boolean> => {
  ...
  if (!hasPermission) {
    ...
    console.log('check 4:', permissionRequestResult);
...
// const isVideoOnLoadEvent = (event: NativeSyntheticEvent<ImageLoadEventData>): event is OnLoadData =>
  ...
  return (
    <View style={[styles.container, screenStyle]}>
      ...
      <TouchableOpacity
        ...
        {savingState === 'none' && (
          <Icon name="download" size={35} color="white" style={styles.icon} />
        )}
        {savingState === 'saved' && (
          <Icon name="checkmark" size={35} color="white" style={styles.icon} />
        )}
        {savingState === 'saving' && <ActivityIndicator color="white" />}
      </TouchableOpacity>
